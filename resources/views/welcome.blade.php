    ...
    <div class="flex flex-col items-center justify-center min-h-screen px-4">
        <div class="text-center max-w-4xl mx-auto">
            <h1 class="text-5xl md:text-7xl font-bold text-gray-900 mb-8">
                {{ __('welcome') }} <span class="text-primary-600">Bazaar</span>
            </h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 max-w-3xl mx-auto">
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-sm font-medium">{{ __('buy') }}</span>
                </div>
                <div class="flex flex-col items-center">
                    <div class="bg-primary-100 p-3 rounded-full mb-3">
                        <svg class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">{{ __('sell') }}</span>
                </div>
                <div class="flex flex-col items-center">
                    <div class="bg-primary-100 p-3 rounded-full mb-3">
                        <svg class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">{{ __('auction') }}</span>
                </div>
                <div class="flex flex-col items-center">
                    <div class="bg-primary-100 p-3 rounded-full mb-3">
                        <svg class="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">{{ __('rent') }}</span>
                </div>
            </div>
        </div>
    </div>
