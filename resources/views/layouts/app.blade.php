        ...
        <div style="width: 15rem" class="p-2 flex h-full flex-col">
            ...
            <div class="flex flex-col gap-2 flex-1">
                <ul class="uk-nav uk-nav-primary">
                    <?php
                    const links = [
                        'seller.business.index' => ['label' => 'business', 'icon' => 'store'],
                        'seller.advertisements.index' => ['label' => 'advertisements.title', 'icon' => 'megaphone'],
                        'seller.agenda.index' => ['label' => 'agenda.title', 'icon' => 'calendar'],
                        'seller.api.index' => ['label' => 'api.title', 'icon' => 'webhook'],
                    ];
                    ?>
